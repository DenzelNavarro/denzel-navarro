...
const socialLinks = [
  {
    href: "https://github.com/DenzelNavarro",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/denzel-navarro-82897b228/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/denzeruuu/",
    icon: (
      <svg
        width="25"
        height="24"
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-4 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Feel free to reach out if you'd like to connect, have questions, or
        ...
        <form
          action="https://getform.io/f/bjjjjzlb"
          method="POST"
          className="xl:pl-10 2xl:pl-20 mt-8 lg:mt-0"
        >
